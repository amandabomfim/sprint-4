            ...
            <div className="pedalEssencial">
                <ComponentePlano titulo="Pedal Essencial">
                    <ul>
                        ...
                        <li>
                            Substituição ou regulagem de selim e canote
                            de selim.
                        </li>
                        <li>
                            Substituição e regulagem manetes de freios e
                            cabo de aço.
                        </li>
                        <li>
                            Substituição ou regulagem de freio dianteiro
                            e traseiro.
                        </li>
                    </ul>
                </ComponentePlano>
            ...
            <div className="pedalLeve">
                <ComponentePlano titulo="Pedal Leve">
                    <ul>
                        ...
                        <li>
                            Transporte do segurado e Bike - limite de
                            50km, em caso de quebra ou acidente.
                        </li>
                    </ul>
                </ComponentePlano>
            </div>
            ...
            <div className="pedalElite">
                <ComponentePlano titulo="Pedal Elite">
                    <ul>
                        ...
                        <li>
                            Transporte do segurado e Bike - limite de
                            150km, em caso de quebra ou acidente.
                        </li>
                        <li>
                            Instalação de suporte de parede e chão para
                            bike.
                        </li>
                        <li>
                            Serviço de Leva e Traz, com limite de 50km,
